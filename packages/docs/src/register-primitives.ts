...
import { DuiToastPrimitive, DuiToastRegionPrimitive, DuiToastActionPrimitive, DuiToastClosePrimitive } from "@dui/primitives/toast";
...
reg(DuiToastRegionPrimitive);
reg(DuiToastPrimitive);
reg(DuiToastActionPrimitive);
reg(DuiToastClosePrimitive);
