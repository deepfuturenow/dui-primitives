...
export const primitiveRegistry: PrimitiveMeta[] = [
  ...
  },
  {
    ...
    name: "Toast Region",
    description: "Viewport and provider for a stack of toasts. Manages position, registry, and pause-on-hover/focus/visibility.",
    importPath: "@dui/primitives/toast",
    properties: [
      { name: "position", type: '"top-left" | "top-center" | "top-right" | "bottom-left" | "bottom-center" | "bottom-right"', default: '"bottom-right"', description: "Anchor position of the region." },
      { name: "maxVisible", type: "number", default: "3", description: "Maximum simultaneously-visible toasts. Older toasts get data-overflow." },
      { name: "label", type: "string", default: '"Notifications"', description: "Accessible landmark label." },
      { name: "expandOnHover", type: "boolean", default: "true", description: "Auto-expand on pointer hover or focus inside the region." },
      { name: "expanded", type: "boolean | undefined", description: "Controlled expanded state. Overrides hover/focus." },
      { name: "swipeDirections", type: "string", description: "Comma-separated allowed swipe directions, or 'none'. Defaults to outward-from-anchor." },
      { name: "swipeThreshold", type: "number", default: "50", description: "Distance (px) before a swipe commits to dismissal." },
      { name: "hotkey", type: "string", default: '"Alt+T"', description: "Global hotkey that focuses the front toast. Set 'none' to disable." },
    ],
    events: [
      { name: "toast-dismiss", detail: "{ id, reason }", description: "Bubbled when any toast inside is dismissed." },
    ],
    slots: [{ name: "default", description: "One or more <dui-toast> elements." }],
    cssParts: [{ name: "list", description: "The list container." }],
  },
  {
    tagName: "dui-toast",
    name: "Toast",
    description: "A single toast notification with auto-dismiss, ARIA wiring, and three escape valves for content control.",
    importPath: "@dui/primitives/toast",
    parent: "dui-toast-region",
    properties: [
      ...
      { name: "duration", type: "number", default: "4000", description: "Auto-dismiss timeout (ms). 0 disables." },
      ...
      { name: "priority", type: '"polite" | "assertive"', default: '"polite"', description: "Live-region politeness." },
      { name: "toastId", type: "string", description: "Stable id; auto-generated if omitted." },
      { name: "headless", type: "boolean", default: "false", description: "Tier-3 escape hatch: render only the default slot, no title/description/action/close wrappers." },
    ],
    events: [
      { name: "open-change", detail: "{ open: boolean }", description: "Fired on open/close transitions." },
      { name: "dismiss", detail: "{ id, reason }", description: "Reason: auto | action | close | programmatic | swipe | keyboard." },
    ],
    slots: [
      { name: "default", description: "Default content; rendered after title/description." },
      { name: "title", description: "Title content; auto-wires aria-labelledby." },
      { name: "description", description: "Description content; auto-wires aria-describedby." },
      { name: "action", description: "Action region (typically <dui-toast-action>)." },
      { name: "close", description: "Close region (typically <dui-toast-close>)." },
    ],
    cssParts: [
      { name: "root", description: "The toast container." },
      { name: "title", description: "Title wrapper." },
  ...
  },
  {
    ...
    name: "Toast Action",
    description: "Wrapper that dismisses the parent toast on click with reason 'action'.",
    importPath: "@dui/primitives/toast",
    parent: "dui-toast-region",
    properties: [],
    events: [],
    slots: [{ name: "default", description: "Action button or content." }],
  },
  {
    tagName: "dui-toast-close",
    name: "Toast Close",
    description: "Wrapper that dismisses the parent toast on click with reason 'close'.",
    importPath: "@dui/primitives/toast",
    parent: "dui-toast-region",
    properties: [],
    events: [],
    slots: [{ name: "default", description: "Close button or icon." }],
  },
  {
    tagName: "dui-tooltip",
    name: "Tooltip",
  ...
  },
  {
    tagName: "dui-popover",
    name: "Popover",
    description: "A floating panel anchored to a trigger element. Uses Floating UI for positioning.",
    importPath: "@dui/primitives/popover",
    properties: [
      ...
      { name: "side", type: '"top" | "bottom"', default: '"bottom"', description: "Which side of the trigger the popover appears on" },
      { name: "sideOffset", type: "number", default: "8", description: "Offset from the trigger in pixels" },
    ],
    events: [
      { name: "open-change", detail: "{ open: boolean }", description: "Dispatched when the popover opens or closes" },
    ],
    slots: [{ name: "default", description: "dui-popover-trigger and dui-popover-popup" }],
  },
  {
    ...
    properties: [],
    events: [],
    slots: [{ name: "default", description: "Trigger content (button, link, etc.)" }],
  },
  {
    tagName: "dui-popover-popup",
    name: "Popover Popup",
    description: "The floating popover content container.",
    importPath: "@dui/primitives/popover",
    parent: "dui-popover",
    properties: [
      { name: "showArrow", type: "boolean", default: "true", description: "Whether to show an arrow pointing to the trigger" },
      { name: "closeOnClick", type: "boolean", default: "false", description: "Close the popover when content inside is clicked" },
    ],
    events: [],
    slots: [{ name: "default", description: "Popover content" }],
  },
  {
    ...
    properties: [],
    events: [],
    slots: [{ name: "default", description: "Close button content" }],
  },
  {
...
export const NAV_GROUPS: { label: string; slugs: string[] }[] = [
  {
    ...
    slugs: [
      ...
      "splitter",
      "stepper", "switch", "tabs", "textarea", "toast", "toggle", "toggle-group",
