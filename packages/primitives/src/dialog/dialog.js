...
let DuiDialogPrimitive = (() => {
    ...
    return class DuiDialogPrimitive extends _classSuper {
        static {
            ...
            __ctx_decorators = [provide({ context: dialogContext }), state()];
